...
<sub>*An AI agency site in four languages, where every illustration is generated by code.*</sub>

<a href="https://ferhat-yasinoglu.github.io/fy-ajans/">
  <img src="https://raw.githubusercontent.com/Ferhat-Yasinoglu/ferhat-yasinoglu/main/assets/fy-ajans.jpg" width="100%" alt="FY Ajans homepage" />
</a>

No framework and no build step for the site itself — but nothing on it is a stock image
either. The letter mark, the glow around the portrait, the course cover, the knowledge
graph and the seven chapter covers are all animated SVGs written by Node scripts, each
with a still version for visitors who ask for less motion. One Turkish source becomes
German, English and Persian, and the whole layout flips for Persian.
