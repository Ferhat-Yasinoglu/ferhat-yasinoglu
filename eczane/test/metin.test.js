...
describe('telefonNormalize', () => {
  it('baştaki sıfırı ülke koduyla değiştirir', () => {
    expect(telefonNormalize('0700000000', '93')).toBe('93700000000');
    expect(telefonNormalize('0532 000 00 01', '90')).toBe('905320000001');
  });
  it('artı ile başlayan numarayı olduğu gibi alır', () => {
    expect(telefonNormalize('+93 700 000 000', '90')).toBe('93700000000');
    expect(telefonNormalize('0093700000000')).toBe('93700000000');
  });
  it('zaten ülke koduyla başlayan numarayı tekrarlamaz', () => {
    expect(telefonNormalize('93700000000', '93')).toBe('93700000000');
  });
  it('ülke kodu yoksa yalnız rakamları verir', () => {
    expect(telefonNormalize('700-000-000')).toBe('700000000');
  });
