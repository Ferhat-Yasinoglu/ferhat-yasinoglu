...
const SIMGELER = {
  ...
  /* Reçete kâğıdının antet ve ayak süslemeleri */
  asa: [
    ['circle', { cx: 12, cy: 3.4, r: 1.5 }],
    ['path', { d: 'M12 5.2v15.6' }],
    ['path', { d: 'M12 9c-2.5.9-2.5 2.7 0 3.6s2.5 2.7 0 3.6' }],
    ['path', { d: 'M12 9c2.5.9 2.5 2.7 0 3.6s-2.5 2.7 0 3.6' }],
    ['path', { d: 'M10.9 7.8C8.6 5.9 5.4 5.5 3.2 6.9c1.2 2.3 4 3.5 7.7 3.5' }],
    ['path', { d: 'M13.1 7.8c2.3-1.9 5.5-2.3 7.7-.9-1.2 2.3-4 3.5-7.7 3.5' }],
  ],
  stetoskop: [
