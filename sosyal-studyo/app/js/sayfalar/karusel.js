...
async function duzenle(kok, ctx, id) {
  ...
  kok.append(el('div', { class: 'sayfa-bas' }, btn('←', { class: 'btn btn--ikon btn--sade', 'aria-label': t('geri', 'Geri'), onclick: () => git('/karusel') }), el('div', { class: 'sayfa-bas__govde' }, el('h1', {}, baslik))),
