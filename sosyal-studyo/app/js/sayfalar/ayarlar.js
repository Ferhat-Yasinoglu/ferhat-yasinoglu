    ...
    async function workerCiz() {
      ...
      async function dogrula() {
        ...
        try {
          ...
          ctx.basari(t('worker.bagli', 'Bağlandı')); ctx.yenileBantlar();
