...
export const ADIM_BILGI = {
  message:       { ad: 'Mesaj',           simge: '💬' },
  question:      { ad: 'Soru',            simge: '❓' },
  buttons:       { ad: 'Butonlar',        simge: '🔘' },
  delay:         { ad: 'Gecikme',         simge: '⏳' },
  tag:           { ad: 'Etiket',          simge: '🏷️' },
  goto:          { ad: 'Atla',            simge: '↪️' },
  end:           { ad: 'Bitir',           simge: '⏹️' },
  note:          { ad: 'Not',             simge: '📝' },
  condition:     { ad: 'Koşul',           simge: '🔀' },
  ai_reply:      { ad: 'AI cevabı',       simge: '✨' },
  score:         { ad: 'Puan',            simge: '⭐' },
  webhook:       { ad: 'Webhook',         simge: '🔗' },
  comment_reply: { ad: 'Yoruma yanıt',    simge: '💭' },
  private_reply: { ad: 'Yorum → DM',      simge: '📩' },
  hide:          { ad: 'Yorumu gizle',    simge: '🙈' },
};
